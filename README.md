...
✅| POET training and evaluation code for our Activity Recognition benchmark on NTU RGB+D dataset is now available. We prompt offset tuning the CTR-GCN graph convolutional network backbone. 
